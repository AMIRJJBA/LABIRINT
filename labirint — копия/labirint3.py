...
#back = (119, 210, 223)
back = transform.scale(image.load('kchau.jpg'), (win_width, win_height))
...
w3 = GameSprite('platform1.png', 100,100,1080,50)
w4 = GameSprite('platform1.png', )
barriers.add(w1) 
barriers.add(w2) 
barriers.add(w3)
